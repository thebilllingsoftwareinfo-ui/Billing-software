...
import { Users, UserPlus, Shield, CheckCircle, Clock, AlertOctagon, RefreshCw, Send, UserX, Key, Activity, ShieldAlert } from 'lucide-react';
                      ...
                      {member.role !== 'owner' ? (
                        <div className="flex items-center justify-end gap-1.5">
                          <Button
                            ...
                            className={
                              member.status === 'active'
                                ? 'text-amber-600 hover:text-amber-700 hover:bg-amber-50 h-7 text-xs px-2'
                                : 'text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 h-7 text-xs px-2'
                            }
                          >
                          ...
                          <RowActionsMenu
                            items={[
                              ...
                              },
                              {
                                ...
                                icon: Send,
                                onClick: () => toast.success('Staff invitation email resent'),
                                divider: true,
                              },
                              {
                                label: member.status === 'active' ? 'Suspend Staff Member' : 'Reactivate Staff Member',
                                icon: AlertOctagon,
                                onClick: () => handleStatusToggle(member.id, member.status),
                              },
                              {
                        ...
                        <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Owner (Root)</span>
                      )}
                    </td>
                  </tr>
                ))
